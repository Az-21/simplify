...
/// Constant fields
const String _title = "Title case";
const String _subtitle = "Capitalize first letter of every word except articles";

class TitleCaseOption extends StatefulWidget {
  const TitleCaseOption({Key? key}) : super(key: key);

  @override
  State<TitleCaseOption> createState() => _TitleCaseOptionState();
}

class _TitleCaseOptionState extends State<TitleCaseOption> {
  /// Field
