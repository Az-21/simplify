...
/// Constant fields
const String _title = "Lowercase";
const String _subtitle = "Change every letter to lowercase";

class LowerCaseOption extends StatefulWidget {
  const LowerCaseOption({Key? key}) : super(key: key);
  @override
  State<LowerCaseOption> createState() => _LowerCaseOptionState();
}

class _LowerCaseOptionState extends State<LowerCaseOption> {
  /// Field
